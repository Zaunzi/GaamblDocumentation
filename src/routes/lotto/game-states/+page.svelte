...
<svelte:head>
	<title>Game States - Gaambl Lotto Documentation</title>
</svelte:head>
...
<div class="max-w-4xl mx-auto">
	...
	<div class="mb-8">
		<div class="flex items-center mb-4">
			...
			<h1 class="text-4xl font-bold text-surface-900 dark:text-surface-100">Game States</h1>
		</div>
	...
	<!-- State Overview -->
	<section class="mb-12">
		<h2 class="text-3xl font-bold text-surface-900 dark:text-surface-100 mb-6">Game State Lifecycle</h2>
		...
		<div class="space-y-6">
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					<p><strong>Duration:</strong> From creation until max players reached or expiration</p>
					<p><strong>Player Actions:</strong> Can join by paying entry fee</p>
					<p><strong>Auto-Complete:</strong> Triggers when max players reached</p>
				</div>
			</div>
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					<p><strong>Trigger:</strong> Max players reached OR manual completion of expired game</p>
					<p><strong>Duration:</strong> Usually 1-2 blocks, max 10 minutes before retry possible</p>
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					...
					<p><strong>Finalization:</strong> Anyone can call finalizeGameCompletion(gameId)</p>
					<p><strong>Bot Opportunity:</strong> Monitor for this state to trigger finalization</p>
				</div>
			</div>
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					<p><strong>Winners:</strong> Can claim prizes with claimPrize(gameId)</p>
					<p><strong>Final State:</strong> No further state changes possible</p>
					<p><strong>Prizes:</strong> Must be manually claimed by winners</p>
				</div>
			</div>
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					<p><strong>Trigger:</strong> Emergency admin action or zero participants at expiration</p>
					<p><strong>Refunds:</strong> All participants get full refunds through claim system</p>
					<p><strong>Final State:</strong> No further actions possible</p>
				</div>
			</div>
			...
			<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
				...
				<div class="space-y-2 text-sm text-surface-600 dark:text-surface-400">
					<p><strong>Trigger:</strong> Single participant (creator) at expiration</p>
					<p><strong>Refund:</strong> Single participant gets entry fee back</p>
					<p><strong>Automatic:</strong> Handled automatically during expired game completion</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="mb-12">
		...
		<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
			...
			<div class="space-y-4">
				...
				<div class="bg-surface-100 dark:bg-surface-800 rounded p-4">
					<h4 class="font-semibold text-surface-900 dark:text-surface-100 mb-2">Expired Game Flow</h4>
					<p class="text-sm text-surface-600 dark:text-surface-400">
				...
				<div class="bg-surface-100 dark:bg-surface-800 rounded p-4">
					<h4 class="font-semibold text-surface-900 dark:text-surface-100 mb-2">Emergency Flow</h4>
					<p class="text-sm text-surface-600 dark:text-surface-400">
	...
	<!-- Monitoring -->
	<section class="mb-12">
		<h2 class="text-3xl font-bold text-surface-900 dark:text-surface-100 mb-6">Monitoring Games</h2>
		<div class="bg-surface-50 dark:bg-surface-900 rounded-lg p-6">
			<p class="text-surface-600 dark:text-surface-400 mb-4">
			...
			<div class="space-y-4">
				<div class="bg-surface-100 dark:bg-surface-800 rounded p-4">
					...
					<ul class="text-sm text-surface-600 dark:text-surface-400 space-y-1">
						<li>• <code>getGameBasicInfo(gameId)</code> - Get current game state and info</li>
						<li>• <code>isGameReadyForCompletion(gameId)</code> - Check if ready for finalization</li>
						<li>• <code>isGameExpired(gameId)</code> - Check if game can be manually completed</li>
					</ul>
				</div>
				...
				<div class="bg-surface-100 dark:bg-surface-800 rounded p-4">
					...
					<ul class="text-sm text-surface-600 dark:text-surface-400 space-y-1">
						<li>• <code>finalizeGameCompletion(gameId)</code> - Finalize ready games</li>
						<li>• <code>completeExpiredGame(gameId)</code> - Complete expired games</li>
						<li>• <code>retryRandomness(gameId)</code> - Retry failed randomness (admin only)</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="flex justify-between items-center pt-8 border-t border-surface-200 dark:border-surface-700">
		<a href="/lotto/game-modes" class="text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-200">
			← Game Modes
		</a>
		<a href="/lotto/creating-games" class="text-primary-600 dark:text-primary-400 hover:text-primary-800 dark:hover:text-primary-200">
			Creating Games →
		</a>
	</div>
</div>
